...
public class ImAxesMenuSystem : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            dropdown.AddOptions(ScatterPlotSceneManager.Instance.dataObject.Identifiers.ToList());
        }
    ...
    public void OnPointSizeAttributeChanged(int idx)
    {
        ...
        {
            VisualisationAttributes.Instance.sizes = ScatterPlotSceneManager.Instance.dataObject.getDimension(VisualisationAttributes.Instance.SizeAttribute);
        }
        else
        {
    ...
    void UpdateColorMapping()
    {
        ...
        {
            VisualisationAttributes.Instance.colors = VisualisationAttributes.getContinuousColors(VisualisationAttributes.Instance.MinGradientColor, VisualisationAttributes.Instance.MaxGradientColor, ScatterPlotSceneManager.Instance.dataObject.getDimension(VisualisationAttributes.Instance.ColoredAttribute));
        }
        else
        {
